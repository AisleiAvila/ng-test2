...
describe(PhotoFrameComponent.name, () => {
    ...
    it(`#${PhotoFrameComponent.prototype.like.name}
        ...
        multiple times within debounce time`, fakeAsync(() => {
            ...
            component.like();
            component.like();
            tick(500); // Para a execução por meio segundo
            expect(times).toBe(1);
    }));

    it( `#${PhotoFrameComponent.prototype.like.name}
        Should trigger (@Output liked) two lines when 
    ...
    it(`(D) Should display number of lines when (@Input likes) is incremented`, () => {
        fixture.detectChanges();
        component.likes++;
        fixture.detectChanges();
    ...
    it(`(D) Should have area-label with default (@Input likes)`, () => {
        fixture.detectChanges();
        const element: HTMLElement = fixture.nativeElement.querySelector('span');
